...
flow:
  ...
  inputs:
    - account_create_request: |-
        ${'''{
          "accountType": "USER",
          "address": "4555 Great America Parkway",
    ...
    - http_client_action:
        do:
          io.cloudslang.base.http.http_client_action:
            ...
            - response_character_set: "${get_sp('advantage___accountservice_war_rest_api_request_character_set')}"
            - url: '${url}'
  ...
  graph:
    steps:
      http_client_action:
        ...
        'y': 150
        navigate:
          6b0902cf-2889-bb77-417c-f983203c646e:
            targetId: 9a1d8b96-65b7-3998-6215-1702e2b477f6
            port: SUCCESS
    results:
      SUCCESS:
        9a1d8b96-65b7-3998-6215-1702e2b477f6:
          x: 400
          'y': 150
