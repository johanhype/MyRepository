...
operation:
  ...
  sequential_action:
    gav: com.microfocus.seq:web_action.account_register2:1.0.0
    skills:
    - Web
    settings:
      windows:
    ...
    - step:
        id: '2'
        object_path: Browser("Advantage Shopping").Page("Advantage Shopping").Link("CREATE
          NEW ACCOUNT")
        action: Click
    ...
    - step:
        ...
        action: SetSecure
        default_args: '"password123"'
        snapshot: .\Snapshots\ssf6.html
        highlight_id: '10000000'
    - step:
        id: '7'
        object_path: Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("Confirm
          password")
        action: Click
    ...
    - step:
        id: '13'
        object_path: Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("*UsernameUsername")
        action: Click
    ...
    - step:
        id: '15'
        object_path: Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("Last
          NameLast Name")
        action: Click
    ...
    - step:
        id: '18'
        object_path: Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("REGISTER
          ALREADY HAVE")
        action: Click
    ...
    - step:
        id: '20'
        object_path: Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("i_agreeI
          agree to the")
        action: Click
...
object_repository:
  ...
  - object:
      ...
      comments: ''
      visual_relations: ''
      last_update_time: Tuesday, January 21, 2025 10:25:49 AM
      child_objects:
      - object:
          class: Page
          name: Advantage Shopping
          ...
          - object:
              ...
              - property:
                  value:
                    value: REGISTER ALREADY HAVE AN ACCOUNT?
                    regular_expression: false
                  name: innertext
                  hidden: false
                  read_only: false
              ...
              - property:
                  value:
                    value: //SECTION[@id="registerPage"]/ARTICLE[1]/SEC-FORM[1]/DIV[2]
                    regular_expression: false
                  name: _xpath
                  hidden: true
                  read_only: true
          ...
          - object:
              ...
              - property:
                  value:
                    value: i_agreeI agree to the www.AdvantageOnlineShopping.com Conditions
              ...
              - property:
                  value:
                    value: //DIV[@id="formCover"]/SEC-VIEW[1]/DIV[1]
                    regular_expression: false
                  name: _xpath
                  hidden: true
                  read_only: true
          ...
          - object:
              ...
              - property:
                  value:
                    value: //SEC-VIEW/DIV[normalize-space()="*UsernameUsername"]
                    regular_expression: false
                  name: _xpath
                  hidden: true
                  read_only: true
          ...
          - object:
              ...
              - property:
                  value:
                    value: '*Confirm passwordConfirm password field is required'
                    regular_expression: false
                  name: innertext
                  hidden: false
                  read_only: false
          ...
          - object:
              ...
              - property:
                  value:
                    value: ng-pristine ng-untouched ng-valid ng-scope in-focus ng-dirty-add
                      ng-valid-parse-add ng-animate ng-pristine-remove
                    regular_expression: false
                  name: class
                  hidden: true
                  read_only: true
