...
operation:
  ...
  inputs:
    - category: Speakers
    - product: HP Roar Wireless Speaker
    - email: sm@opentext.com
    - subject: Is this loud enough?
  sequential_action:
    gav: 'com.microfocus.seq:AOS.send_query_act:1.0.0'
    skills:
      - Web
    settings:
      windows:
    ...
    steps:
      ...
      - step:
          id: '2'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("CategorySelect CategoryLaptops")'
          action: Click
      ...
      - step:
          ...
          action: Select
          default_args: '"HP Chromebook 14 G1(ENERGY STAR)"'
          snapshot: ".\\Snapshots\\ssf4.html"
          highlight_id: '10000000'
          args: 'Parameter("product")'
      - step:
          id: '5'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("*EmailEmail")'
          action: Click
          ...
          - object:
              ...
              child_objects:
                - object:
                    ...
                    class: WebList
                    visual_relations: ''
                    last_update_time: 'Tuesday, January 21, 2025 8:41:29 AM'
                ...
                - object:
                    smart_identification:
                      ...
                      algorithm: Mercury.TolerantPriority
                      active: true
                    name: CategorySelect CategoryLaptops
                    child_objects: []
                    properties:
                      - property:
                          value:
                      ...
                      - property:
                          value:
                            value: CategorySelect CategoryLaptopsHeadphonesTabletsSpeakersMiceCategory
                            regular_expression: false
                          name: innertext
                          hidden: false
                          read_only: false
                      ...
                      - property:
                          value:
                            value: '//DIV[@id="supportCover"]/DIV[2]/SEC-FORM[1]/DIV[1]/DIV[1]/SEC-VIEW[1]/DIV[1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//SEC-VIEW/DIV[normalize-space()="*EmailEmail"]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
